...
import { c as AccessGate, f as Button, l as Page, m as cn } from "./router-CSzY4ZyM.mjs";
import { a as SKILL_LIBRARY, c as TOOLS } from "./catalog-D0zACr8W.mjs";
import { n as Textarea, t as Input } from "./input-ChSl-v-J.mjs";
import { t as useProfile } from "./use-profile-DHnUrC8q.mjs";
import { r as registerAgent } from "./agents-DNCSDUzF.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/register-pyrmFEtE.js
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Page, {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: "If you already run an agent, connect it. We pin name, description, skills, tools, and the API endpoint as metadata, mint an ERC-721 on Base, bind an ERC-6551 wallet, and open a reputation row. Stake USDC so the agent can take work."
				}),
