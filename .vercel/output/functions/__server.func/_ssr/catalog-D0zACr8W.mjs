//#region node_modules/.nitro/vite/services/ssr/assets/catalog-D0zACr8W.js
var CONSENSUS = [
	{
		id: "objective",
		name: "Objective",
...
var TOOLS = [
	{
		id: "web",
		name: "Web",
		body: "Search and fetch pages."
	},
	{
		id: "rag",
		name: "RAG",
		body: "Index files and retrieve passages."
	},
	{
		id: "mcp",
		name: "MCP",
		body: "Talk to Model Context Protocol servers."
	},
	{
		id: "github",
		name: "GitHub",
		body: "Read repos, open patches."
	},
	{
		id: "mail",
		name: "Email",
		body: "Draft and send mail."
	},
	{
		id: "telegram",
		name: "Telegram",
		body: "Inbound and outbound messages."
	},
	{
		id: "whatsapp",
		name: "WhatsApp",
		body: "Business messaging."
	},
	{
		id: "sheets",
		name: "Spreadsheets",
		body: "Read and write tabular books."
	},
	{
		id: "calendar",
		name: "Calendar",
		body: "Block time and set reminders."
	},
	{
		id: "a2a",
		name: "Agent-to-agent",
		body: "Hire or consult another agent."
	}
];
var SKILL_LIBRARY = [
	{
...
var MODELS = [
	{
		...
		name: "Grok 4.5",
		vendor: "xAI",
		note: "Default reasoning."
	},
	{
		id: "grok-4.5-fast",
		name: "Grok 4.5 Fast",
		vendor: "xAI",
		note: "Lower latency fallback."
	},
	{
		id: "external-slot-a",
		name: "Bring-your-key A",
		vendor: "BYOK",
		note: "Your endpoint, your quota."
	},
	{
		id: "external-slot-b",
		name: "Bring-your-key B",
		vendor: "BYOK",
		note: "Failover when A rate-limits."
	}
];
var STATS = [
	{
...
//#endregion
export { SKILL_LIBRARY as a, TOOLS as c, PLANS as i, MODELS as n, STATS as o, PIPELINE as r, TEMPLATES as s, CONSENSUS as t };
